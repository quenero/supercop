#ifdef __APPLE__
  #define QMR_LOCAL_SYMBOL(x) .private_extern x
#else
  #define QMR_LOCAL_SYMBOL(x) .hidden x
#endif
...
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
QMR_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
